    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        <div class="md:col-span-4">
            <div class="w-full rounded-xl overflow-hidden shadow-2xl shadow-amber-900/20">
                <img src="character-portrait.png" alt="Portrait of Benjamin Natalli" class="w-full h-full object-cover">
            </div>
...
const projectsData = {
    ...
    'skeletons': {
        ...
        image: 'images/cards/skeletons-card.png',
        video: null,
